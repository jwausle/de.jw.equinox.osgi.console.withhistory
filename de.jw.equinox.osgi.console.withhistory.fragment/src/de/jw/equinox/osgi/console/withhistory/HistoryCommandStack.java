...
public class HistoryCommandStack {
  ...
  /**
   * @param command maybe null command.
  ...
  /**
   * @return historySession.list.<b>head</b>(if exist) || history.<b>pop</b>(if exist) || <b>""</b>.
   */
  ...
  /**
   * @param command to append command.
   */
  public void add(final String command) {
    ...
    if (trimedCommand.endsWith("\r")) {
      trimedCommand = trimedCommand.substring(0, trimedCommand.length() - 1);
    }
  ...
  public String toString() {
    return "IOConsoleWithHistoryData [history=" + this.history + ", historySession=" + this.historySession + "]";
  }
